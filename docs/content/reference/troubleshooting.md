...
Most of these come down to network reality or how csstricks serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

csstricks rate-limits like any public site. cst already paces
...
Where a surface is gated, cst reads a cookie or token you supply
...
`cst`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what cst actually did
